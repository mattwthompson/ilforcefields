...
TESTFILES_DIR = resource_filename('ilforcefields', '/tests/kpl_test_files')


class TestKPL(object):
...
if __name__ == '__main__':
    TestKPL().find_correctly_implemented()
