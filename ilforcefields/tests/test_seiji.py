...
TESTFILES_DIR = resource_filename('ilforcefields', '/tests/seiji_test_files')

class Testseiji(object):
    ...
    def test_atomtyping(self, mol_name, testfiles_dir=TESTFILES_DIR):
        ...
        typed_struct = SEIJI.apply(struct,
...
if __name__ == '__main__':
    Testseiji().find_correctly_implemented()
